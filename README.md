...
If you see TLS/SSL errors when connecting to Atlas, ensure you run a modern Node (Node 18+ / 20 recommended). You can also try temporarily forcing TLS 1.2 for a single run:
